 ...
 * </p>
 * <ul>
 *   <li>{@link com.orka.orkametamodel.impl.VolumeImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.VolumeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.VolumeImpl#getMountPath <em>Mount Path</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.VolumeImpl#getSubPath <em>Sub Path</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.VolumeImpl#getPersistentvolume <em>Persistentvolume</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VolumeImpl extends MinimalEObjectImpl.Container implements Volume {
	...
	public EList<com.orka.orkametamodel.Container> getContainer() {
		if (container == null) {
			container = new EObjectWithInverseResolvingEList.ManyInverse<com.orka.orkametamodel.Container>(
					com.orka.orkametamodel.Container.class, this, MetamodelPackage.VOLUME__CONTAINER,
