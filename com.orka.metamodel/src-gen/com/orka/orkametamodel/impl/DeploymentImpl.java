 ...
 * </p>
 * <ul>
 *   <li>{@link com.orka.orkametamodel.impl.DeploymentImpl#getCluster <em>Cluster</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.DeploymentImpl#getReplicas <em>Replicas</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.DeploymentImpl#getContainers <em>Containers</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.DeploymentImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.orka.orkametamodel.impl.DeploymentImpl#getScalingpolicy <em>Scalingpolicy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentImpl extends MinimalEObjectImpl.Container implements Deployment {
	 ...
	 * @ordered
	 */
	protected EList<com.orka.orkametamodel.Container> containers;
	 ...
	 * @generated
	 */
	public EList<com.orka.orkametamodel.Container> getContainers() {
		if (containers == null) {
			containers = new EObjectWithInverseResolvingEList<com.orka.orkametamodel.Container>(
					com.orka.orkametamodel.Container.class, this, MetamodelPackage.DEPLOYMENT__CONTAINERS,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MetamodelPackage.DEPLOYMENT__CONTAINERS:
			getContainers().clear();
			getContainers().addAll((Collection<? extends com.orka.orkametamodel.Container>) newValue);
			return;
		case MetamodelPackage.DEPLOYMENT__NAME:
