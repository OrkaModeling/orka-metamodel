...
/**
 * This is the item provider adapter for a {@link org.orka.orkametamodel.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addResourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Container_resources_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Container_resources_feature",
								"_UI_Container_type"),
						MetamodelPackage.Literals.CONTAINER__RESOURCES, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Container_volumes_feature",
								"_UI_Container_type"),
						MetamodelPackage.Literals.CONTAINER__VOLUMES, true, false, true, null, null, null));
	}
	...
	protected void addDeploymentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Container_deployment_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Container_deployment_feature",
								"_UI_Container_type"),
						MetamodelPackage.Literals.CONTAINER__DEPLOYMENT, true, false, true, null, null, null));
	}
	...
	protected void addApplicationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Container_application_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Container_application_feature",
								"_UI_Container_type"),
						MetamodelPackage.Literals.CONTAINER__APPLICATION, true, false, true, null, null, null));
	}
