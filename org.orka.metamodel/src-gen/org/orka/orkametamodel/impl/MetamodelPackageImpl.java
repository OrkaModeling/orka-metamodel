...
import org.orka.orkametamodel.CloudNode;
import org.orka.orkametamodel.CloudProperties;
import org.orka.orkametamodel.Cluster;
import org.orka.orkametamodel.ConfigMap;
import org.orka.orkametamodel.Deployment;
import org.orka.orkametamodel.EdgeNode;
import org.orka.orkametamodel.Hypervisor;
...
import org.orka.orkametamodel.MetamodelFactory;
...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @see org.orka.orkametamodel.MetamodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, org.orka.orkametamodel.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Resources(), this.getResources(), this.getResources_Container(), "resources", null,
				0, -1, org.orka.orkametamodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Volumes(), this.getVolume(), this.getVolume_Container(), "volumes", null, 0, -1,
				org.orka.orkametamodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Deployment(), this.getDeployment(), this.getDeployment_Containers(), "deployment",
				null, 1, 1, org.orka.orkametamodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Application(), this.getApplication(), this.getApplication_Container(),
				"application", null, 1, 1, org.orka.orkametamodel.Container.class, !IS_TRANSIENT, !IS_VOLATILE,
