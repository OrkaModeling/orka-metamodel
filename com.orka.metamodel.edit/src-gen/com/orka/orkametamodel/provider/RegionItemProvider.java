...
/**
 * This is the item provider adapter for a {@link com.orka.orkametamodel.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addZonePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Region_zone_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Region_zone_feature", "_UI_Region_type"),
						MetamodelPackage.Literals.REGION__ZONE, true, false, true, null, null, null));
	}
	...
	protected void addClusterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Region_cluster_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Region_cluster_feature",
								"_UI_Region_type"),
						MetamodelPackage.Literals.REGION__CLUSTER, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Region_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Region_name_feature", "_UI_Region_type"),
						MetamodelPackage.Literals.REGION__NAME, true, false, false,
